...
@Module({
  ...
  "password": "erez1234",
  "database": "project",
  "entities": [Products,Users,Orders,Imgs,Cart, Cartdetails, Ratings, Ordersdetails],
  "synchronize": true
}), UsersModule, OrdersModule, ImgsModule, CartModule, CartdetailsModule, RatingsModule, OrdersdetailsModule ],
